        ...
        <ul class="nav nav-tabs padding-18">
            <li>
                <a data-toggle="tab" href="#home">
                    <?php echo $GLOBALS['string']['menu_producer_profil'];?>
                </a>
            </li>
            <li>
                <a data-toggle="tab" href="#pictures">
                    <?php echo $GLOBALS['string']['3dfoot'];?> &
                    <?php echo $GLOBALS['string']['pictures'];?> &
                   <?php echo $GLOBALS['string']['files'];?>
                   </a>
            </li>
            <li>
                <a data-toggle="tab" href="#feed">
                    <?php echo $GLOBALS['string']['teklifver'];?>
                </a>
            </li>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-9">
                        ...
                        <div class="profile-info-row">
                            <div class="profile-info-name"><?php echo $GLOBALS['string']['backend_profil_yasText'];?></div>
                        ...
                        <div class="profile-info-row">
                            <div class="profile-info-name"><?php echo $GLOBALS['string']['backend_profil_boyText'];?></div>
                            <div class="profile-info-value">
                                <span><?php echo $data['lenght'];?></span>
                            </div>
                        </div>

                        <div class="profile-info-row">
                            <div class="profile-info-name"><?php echo $GLOBALS['string']['backend_profil_kiloText'];?></div>
                            <div class="profile-info-value">
                        ...
                        <div class="profile-info-row">
                            <div class="profile-info-name"><?php echo $GLOBALS['string']['backend_profil_aOlcuText'];?></div>
                            <div class="profile-info-value">
                                <span><?php echo $data['footsize'];?></span>
                            </div>
                        </div>
                        ...
                        <div class="widget-box transparent">
                            <div class="widget-header widget-header-small">
                                <h4 class="widget-title smaller">
                                    ...
                                    <?php echo $GLOBALS['string']['backend_profil_exBilgiText'];?>
                                </h4>
                            </div>
            ...
            <div id="pictures" class="tab-pane">
                    ...
                    <ul class="ace-thumbnails">
                        <li>
                            <a href="#" data-rel="colorbox">
                                <img id="myImg" width="150px" height="150px" src="<?php echo $data['image'];?>">
                            </a>
                ...
                <div class="row">
                    <ul class="ace-thumbnails">
                        <li>
                            <a href="#" data-rel="colorbox">
                                <img width="150px" height="150px" src="https://cdn0.iconfinder.com/data/icons/iconico-3/1024/47.png">
                                <div class="text">
                                    <div class="inner">Dosyaadi</div>
                                </div>
                            </a>
                ...
                <div class="row">
                    <img  src="https://img1.cgtrader.com/items/240780/8492f96bd1/human-foot-3d-model-max-obj-3ds-fbx-stl-dwg.jpg">
