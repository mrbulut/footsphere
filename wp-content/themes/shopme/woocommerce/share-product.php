...
<div class="share-links-wrapper v_centered">
	...
	<div class="share-links">
		...
		<?php if (shopme_custom_get_option('share-product-facebook')): ?>
			<a href="https://www.facebook.com/sharer.php?u=<?php echo $permalink ?>" <?php echo $extra_attr ?> title="<?php esc_html_e('Facebook', 'shopme') ?>" class="share-facebook share-link"><?php esc_html_e('Facebook', 'shopme') ?></a>
		<?php endif; ?>
		...
		<?php if (shopme_custom_get_option('share-product-tumblr')): ?>
			<a href="https://www.tumblr.com/share/link?url=<?php echo $permalink ?>&amp;name=<?php echo urlencode($title) ?>&amp;description=<?php echo urlencode(get_the_excerpt()) ?>" <?php echo $extra_attr ?> title="<?php esc_html_e('Tumblr', 'shopme') ?>" class="share-tumblr"><?php esc_html_e('Tumblr', 'shopme') ?></a>
		<?php endif; ?>

		<?php if (shopme_custom_get_option('share-product-reddit')): ?>
			<a href="https://www.reddit.com/submit?url=<?php echo $permalink ?>&amp;title=<?php echo $title ?>" <?php echo $extra_attr ?> title="<?php _e('Reddit', 'shopme') ?>" class="share-reddit"><?php esc_html_e('Reddit', 'shopme') ?></a>
		<?php endif; ?>
