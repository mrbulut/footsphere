...
<?php /* translators: %1$s: Customer full name. %2$s: Order numer */ ?>
	<p><?php printf( __( 'The order #%d from %s has been cancelled. The order was as follows:', 'shopme' ), esc_html( $order->get_formatted_billing_full_name() ), esc_html( $order->get_order_number() )); ?></p>
