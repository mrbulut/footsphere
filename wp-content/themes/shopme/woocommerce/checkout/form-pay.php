...
<form id="order_review" method="post">
	...
	<div id="payment" class="col-2">
		...
		<?php if ( $order->needs_payment() ) : ?>
			...
			<h3><?php esc_html_e( 'Payment', 'shopme' ); ?></h3>
			...
			<ul class="wc_payment_methods payment_methods methods">
				...
				if ( ! empty( $available_gateways ) ) {
					...
					echo '<li>' . apply_filters( 'woocommerce_no_available_payment_methods_message', __( 'Sorry, it seems that there are no available payment methods for your location. Please contact us if you require assistance or wish to make alternate arrangements.', 'shopme' ) ) . '</li>';
				}
				?>
			</ul>
