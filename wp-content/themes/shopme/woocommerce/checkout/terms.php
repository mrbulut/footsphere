...
<div class="woocommerce-terms-and-conditions-wrapper">
	...
	<p class="form-row terms wc-terms-and-conditions">
		...
		<label for="terms" class="woocommerce-form__label woocommerce-form__label-for-checkbox checkbox"><?php printf( __( 'I&rsquo;ve read and accept the <a href="%s" target="_blank">terms &amp; conditions</a>', 'shopme' ), esc_url( wc_get_page_permalink( 'terms' ) ) ); ?> <span class="required">*</span></label>
