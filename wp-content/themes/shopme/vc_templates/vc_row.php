...
if ($css_animation != '') {
	$attributes['animation'] = $css_animation;
	$css_classes[] = $this->getExtraClass('animated');
}
...
$output .= '<div '. esc_attr(shopme_create_data_string($attributes)) .' ' . implode( ' ', $wrapper_attributes ) . '>';
