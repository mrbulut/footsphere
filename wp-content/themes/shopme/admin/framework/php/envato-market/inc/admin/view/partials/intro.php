...
<div class="two-col">
	<div class="col">
		<h1 class="about-title"><strong><?php esc_html_e('Envato Market', 'envato-market'); ?></strong>
			<sup><?php echo esc_html(envato_market()->get_version()); ?></sup></h1>
		...
		<p>
			<strong><?php printf(esc_html__('Development of this plugin is done on %sGitHub%s. Pull requests welcome.', 'envato-market'), '<a href="https://github.com/envato/wp-envato-market" target="_blank">', '</a>'); ?></strong>
		</p>
	</div>
