	...
	class SHOPME_HTML_BUILD extends SHOPME_FRAMEWORK {
		...
		function page_header($option_pages) {
			...
			<div class="mad-admin-bar">
				<a class="help" target="_blank" href="https://velikorodnov.com/online-documentation/shopme/"><?php esc_html_e('Help', 'shopme'); ?></a>
			...
			<li class="mad-footer-holder clearfix">
				<span>
					<?php esc_html_e('Copyright &copy; 2016.', 'shopme') ?>
						<a target="_blank" href="https://themeforest.net/user/mad_velikorodnov?WT.ac=item_profile_text&WT.z_author=mad_velikorodnov"><?php echo esc_html($author) ?></a>
