...
$shopme_elements[] = array(
	...
	$shopme_elements[] =	array(
		...
		"id" 	=> "mad_mailchimp_id",
		"std"   => "5b95a7c729",
		"desc" 	=> wp_kses(__("<a target='_blank' href='https://kb.mailchimp.com/article/how-can-i-find-my-list-id'>Where can I find List ID?</a>", 'shopme'), array('a' => array('href' => array(), 'target' => array())))
	);
	...
	$shopme_elements[] =	array(
		...
		"std" => 'https://www.cookielaw.org/the-cookie-law'
	);
	...
	$shopme_elements[] = array(
		...
		"slug"	=> "shopme",
		"type" 	=> "select",
		"id" 	=> "error_get_widgets_page_id",
		"options" => 'page',
		"desc" 	=> esc_html__('Get widgets for footer from page on 404 page. You can model the footer of any page and then use it to the 404 page', 'shopme'),
	);
...
$shopme_elements[] = array(
	...
	$shopme_elements[] = array(
		...
		"slug"	=> "blog",
		"type" 	=> "select",
		"id" 	=> "blog_get_widgets_page_id",
		"options" => 'page',
		"desc" 	=> esc_html__('Get widgets for footer from page on blog pages. You can model the footer of any page and then use it to the blog pages', 'shopme'),
	);
...
/* ---------------------------------------------------------------------- */
	...
	$shopme_elements[] = array(
		"name" 	=> esc_html__('Get widgets for footer from page for search', 'shopme'),
		"slug"	=> "footer",
		"type" 	=> "select",
		"id" 	=> "search_get_widgets_page_id",
		"options" => 'page',
		"desc" 	=> esc_html__('Get widgets for footer from page on search page. You can model the footer of any page and then use it to the search page', 'shopme'),
	);
...
/* ---------------------------------------------------------------------- */
	...
	$shopme_elements[] = array(
		"name" 	=> esc_html__('Type View', 'shopme'),
		"slug"	=> "shop",
		"type" 	=> "buttons_set",
		"id" 	=> "type-view",
		"options" => array(
		...
		"std" => 'view-grid',
		"desc" 	=> esc_html__('Choose default type view for the Shop page', 'shopme'),
	);
	...
	$shopme_elements[] = array(
		"name" 	=> esc_html__('Show SKU', 'shopme'),
		"slug"	=> "shop",
		"type" 	=> "switch_set",
		"id" 	=> "shop_show_sku",
		"options" => array(
		...
		"std" => true,
		"desc" 	=> esc_html__('If yes to show sku on archive shop', 'shopme')
	);
	...
	$shopme_elements[] = array(
		...
		$shopme_elements[] = array(
			...
			$shopme_elements[] = array(
				...
				"type" 	=> "textarea",
				"id" 	=> "instagram_iframe",
				"desc" 	=> wp_kses(__("How to create instagram widget see instruction: <a target='_blank' href='https://snapwidget.com/'>https://snapwidget.com</a>", 'shopme'), array('a' => array('href' => array(), 'target' => array()))),
				"std" => '<iframe src="https://snapwidget.com/in/?h=YW1hemluZ3xpbnw1NXw0fDR8fG5vfDJ8bm9uZXxvblN0YXJ0fHllc3xubw==&ve=300415" title="Instagram Widget" class="snapwidget-widget" allowTransparency="true" frameborder="0" scrolling="no" style="border:none; overflow:hidden; width:228px; height:228px"></iframe>'
			);
...
/* ---------------------------------------------------------------------- */
	...
	$shopme_elements[] = array(
		...
		"desc" 	=> wp_kses(__("<p>
			...
			<a target='_blank' href='https://velikorodnov.com/wordpress/shopme/'>View Demo Online</a>
	...
	$shopme_elements[] = array(
		...
		"desc" 	=> wp_kses(__("<p>
					<strong>View demo:</strong>
					<a target='_blank' href='https://velikorodnov.com/wordpress/shopmewp/furniture/'>View Demo Online</a>
					</p> You can import default content dummy posts and pages here </br> </br>
					<strong>Before Import Data install you must install and activate the following plugins: </strong>
					<ul>
						<li>Shopme Content Types</li>
	...
	$shopme_elements[] = array(
		...
		"desc" 	=> wp_kses(__("<p>
						<strong>View demo:</strong>
						<a target='_blank' href='https://velikorodnov.com/wordpress/shopmewp/electronics/'>View Demo Online</a>
						</p> You can import default content dummy posts and pages here </br> </br>
						<strong>Before Import Data install you must install and activate the following plugins: </strong>
						<ul>
							<li>Shopme Content Types</li>
