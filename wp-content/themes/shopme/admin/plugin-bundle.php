...
function shopme_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name'      		 => esc_html__('Login With Ajax', 'shopme'),
		...
		array(
			...
			'source'             => ( $check_token ) ? 'http://velikorodnov.com/wordpress/sample-data/shopme/pluginus145/shopme-content-types.zip' : '',
			'required'           => false,
			'version'            => '1.0.4',
			'force_activation'   => false,
			'force_deactivation' => false
		...
		array(
			...
			'source'             => ( $check_token ) ? 'http://velikorodnov.com/wordpress/sample-data/shopme/pluginus145/indeed-smart-popup.zip' : '',
			'required'           => false,
			'version'            => '4.6',
			'force_activation'   => false,
			'force_deactivation' => false
		...
		array(
			'name'               => 'LayerSlider WP',
			'slug'               => 'LayerSlider',
			'source'             => ( $check_token ) ? 'http://velikorodnov.com/wordpress/sample-data/shopme/pluginus145/LayerSlider.zip' : '',
			'required'           => false,
			'version'            => '6.6.4',
			'force_activation'   => false,
			'force_deactivation' => false
		...
		array(
			...
			'slug'               => 'revslider',
			'source'             => ( $check_token ) ? 'http://velikorodnov.com/wordpress/sample-data/shopme/pluginus145/revslider.zip' : '',
			'required'           => false,
			'version'            => '5.4.5.1',
			'force_activation'   => false,
			'force_deactivation' => false
		...
		array(
			...
			'source'             => ( $check_token ) ? 'http://velikorodnov.com/wordpress/sample-data/pluginus/woocommerce-products-filter.zip' : '',
			'required'           => false,
			'version'            => '2.1.9',
			'force_activation'   => false,
			'force_deactivation' => false
		...
		array(
			...
			'source'             => ( $check_token ) ? 'http://velikorodnov.com/wordpress/sample-data/pluginus/envato-wordpress-toolkit-master.zip' : '',
			'required'           => false,
			'version'            => '1.7.3',
			'force_activation'   => false,
			'force_deactivation' => false
		...
		array(
			...
			'source'             => ( $check_token ) ? 'http://velikorodnov.com/wordpress/sample-data/pluginus/rich-snippets-wordpress-plugin.zip' : '',
			'required'           => false,
			'version'            => '1.6.3',
			'force_activation'   => false,
			'force_deactivation' => false
		...
		array(
			...
			'source'             => ( $check_token ) ? 'http://velikorodnov.com/wordpress/sample-data/pluginus/woocommerce-prices-by-user-role.zip' : '',
			'required'           => false,
			'version'            => '4.0',
			'force_activation'   => false,
			'force_deactivation' => false
		...
		array(
			...
			'source'             => ( $check_token ) ? 'http://velikorodnov.com/wordpress/sample-data/pluginus/woo-sale-revolution-flashsale.zip' : '',
			'required'           => false,
			'version'            => '2.7',
			'force_activation'   => false,
			'force_deactivation' => false
		...
		array(
			'name'               => 'Mega Main Menu',
			'slug'               => 'mega-main-menu',
			'source'             => ( $check_token ) ? 'http://velikorodnov.com/wordpress/sample-data/pluginus/mega_main_menu.zip' : '',
			'required'           => false,
			'version'            => '2.1.4',
			'force_activation'   => false,
			'force_deactivation' => false
		...
		array(
			...
			'slug'               => 'js_composer',
			'source'             => ( $check_token ) ? 'http://velikorodnov.com/wordpress/sample-data/pluginus/js_composer.zip' : '',
			'required'           => false,
			'version'            => '5.4.3',
			'force_activation'   => false,
			'force_deactivation' => false
		...
		array(
			'name'               => 'Screets Chat X',
			'slug'               => 'screets-cx',
			'source'             => ( $check_token ) ? 'http://velikorodnov.com/wordpress/sample-data/pluginus/screets-cx.zip' : '',
			'required'           => false,
			'version'            => '2.2.8',
			'force_activation'   => false,
			'force_deactivation' => false
		...
		array(
			...
			'source'             => ( $check_token ) ? 'http://velikorodnov.com/wordpress/sample-data/pluginus/mgwoocommercebrands.zip' : '',
			'required'           => false,
			'version'            => '1.6.2',
			'force_activation'   => false,
			'force_deactivation' => false
 		...
 		array(
			...
			'source'             => 'http://velikorodnov.com/wordpress/sample-data/pluginus/sitepress-multilingual-cms.zip', // The plugin source.
			'required'           => false, // If false, the plugin is only 'recommended' instead of required.
			'version'            => '3.9.3', // E.g. 1.0.0. If set, the active plugin must be this version or higher.
