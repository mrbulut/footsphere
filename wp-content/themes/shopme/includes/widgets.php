		...
		function __construct() {
			...
			$this->settings           = array(
				...
				'facebook_links'  => array(
					...
					'std'   => esc_html__( 'https://www.facebook.com', 'shopme' )
				),
				'twitter_links'  => array(
					'type'  => 'text',
				...
				'gplus_links'  => array(
					...
					'std'   => esc_html__( 'https://plus.google.com/', 'shopme' )
				),
				...
				'instagram_links'  => array(
					...
					'std'   => esc_html__( 'https://instagram.com', 'shopme' )
				),
				'linkedin_links'  => array(
					'type'  => 'text',
					'label' => esc_html__('LinkedIn Link', 'shopme'),
					'std'   => esc_html__( 'https://linkedin.com/', 'shopme' )
				),
				'vimeo_links'  => array(
					'type'  => 'text',
