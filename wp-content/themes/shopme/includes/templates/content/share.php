...
<div class="share-links-wrapper v_centered">
	...
	<div class="share-links">
		...
		<?php if (shopme_custom_get_option('share-posts-facebook')): ?>
			<a href="https://www.facebook.com/sharer.php?u=<?php echo $permalink ?>" <?php echo $extra_attr ?> title="<?php esc_html_e('Facebook', 'shopme') ?>" class="share-facebook"><?php esc_html_e('Facebook', 'shopme') ?></a>
		<?php endif; ?>
		...
		<?php if (shopme_custom_get_option('share-posts-reddit')): ?>
			<a href="https://www.reddit.com/submit?url=<?php echo $permalink ?>&amp;title=<?php echo $title ?>" <?php echo $extra_attr ?> title="<?php esc_html_e('Reddit', 'shopme') ?>" class="share-reddit"><?php esc_html_e('Reddit', 'shopme') ?></a>
		<?php endif; ?>
