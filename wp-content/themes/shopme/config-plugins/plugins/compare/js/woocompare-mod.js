jQuery(document).ready(function($) {
	...
	$('body').on( 'yith_woocompare_open_popup woocompare_open_popup_mod', function () {
		...
		var compare_button = $('.product .compare_button', window.parent.document),
			count_compare = $('.product .count-compare span', window.parent.document),
			data = {
	...
	$('.yith-woocompare-widget').on('click', 'li a.remove, a.clear-all', function (e) {
		...
		var button = $(this),
			compare_button = $('.product .compare_button'),
			count_compare = $('.product .count-compare span', window.parent.document),
			data = {
