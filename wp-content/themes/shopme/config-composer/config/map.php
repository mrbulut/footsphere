...
vc_map( array(
	...
	'params' => array(
		...
		array(
			...
			'param_name' => 'el_id',
			'description' => sprintf( wp_kses(__( 'Enter row ID (Note: make sure it is unique and valid according to <a href="%s" target="_blank">w3c specification</a>).', 'shopme' ), array('a' => array('href' => array(), 'target' => array()))), 'https://www.w3schools.com/tags/att_global_id.asp' ),
		),
		array(
			'type' => 'checkbox',
...
vc_map( array(
	...
	'params' => array(
		...
		array(
			...
			'param_name' => 'link',
			'value' => 'https://vimeo.com/92033601',
			'admin_label' => true,
			'description' => sprintf( wp_kses(__( 'Enter link to video (Note: read more about available formats at WordPress <a href="%s" target="_blank">codex page</a>).', 'shopme' ), array('a' => array('href' => array(), 'target' => array()))), 'https://codex.wordpress.org/Embeds#Okay.2C_So_What_Sites_Can_I_Embed_From.3F' )
		),
		array(
			'type' => 'textfield',
			'heading' => esc_html__( 'Extra class name', 'shopme' ),
...
vc_map( array(
	...
	'params' => array(
		...
		array(
			...
			'description' => esc_html__( 'Show button.', 'shopme' ),
...
vc_map( array(
	...
	'params' => array(
		...
		array(
			...
			"param_name" => "links",
			"holder" => "span",
			"description" => esc_html__( 'Input links values. Divide values with linebreaks (|). Example: https://brand.com | https://brand2.com', 'shopme' )
		),
		array(
			'type' => 'checkbox',
...
if (class_exists('WooCommerce')) {
	...
	vc_map( array(
		...
		'params' => array(
			...
			array(
				'type' => 'checkbox',
				'heading' => esc_html__( 'Show children categories', 'shopme' ),
				'param_name' => 'show_children_categories',
				'description' => esc_html__( 'Show children categories', 'shopme' ),
				'group' => esc_html__( 'Data Settings', 'shopme' ),
				'std' => true,
				'value' => array( esc_html__( 'Yes', 'shopme' ) => true ),
			),
			...
			array(
				'type' => 'checkbox',
				'heading' => esc_html__( 'Show SKU?', 'shopme' ),
				'param_name' => 'show_sku',
				'description' => __( 'Show sku', 'shopme' ),
				'value' => array( esc_html__( 'Yes', 'shopme' ) => true ),
			),
			array(
				'type' => 'dropdown',
