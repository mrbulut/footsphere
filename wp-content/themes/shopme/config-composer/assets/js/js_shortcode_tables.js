(function ($) {
	...
	$.shopme_modal = $.shopme_modal || {};

	$.shopme_modal.tableBuilder = function() {
		...
		var methods = {
			...
			base: function () {
				...
				base.colsEl = $("[name='columns']");
				base.rowsEl = $("[name='rows']");
			...
			listeners: function () {
				...
				$('.wpb_el_type_table-holder').on('keyup', '.wpb_table_data', function (e) {
					var rows = [];
					var colsVal = base.colsEl.val(),
						rowsVal = base.rowsEl.val();
