...
$jscomp.iteratorPrototype=function(a){$jscomp.initSymbolIterator();a={next:a};a[$jscomp.global.Symbol.iterator]=function(){return this};return a};$jscomp.makeIterator=function(a){$jscomp.initSymbolIterator();var b=a[Symbol.iterator];return b?b.call(a):$jscomp.arrayIterator(a)};var indexOf;indexOf="function"===typeof Array.prototype.indexOf?function(a,b){return a.indexOf(b)}:function(a,b){for(var c=0,d=a.length,e=-1,f=!1;c<d&&!f;)a[c]===b&&(e=c,f=!0),c++;return e};
var nBirdEvents=function(){this.events={}};nBirdEvents.prototype.on=function(a,b){"object"!==typeof this.events[a]&&(this.events[a]=[]);this.events[a].push(b)};nBirdEvents.prototype.off=function(a,b){if("object"===typeof this.events[a]){var c=indexOf(this.events[a],b);-1<c&&this.events[a].splice(c,1)}};nBirdEvents.prototype.emit=function(a){var b,c=[].slice.call(arguments,1);if("object"===typeof this.events[a]){var d=this.events[a].slice();var e=d.length;for(b=0;b<e;b++)d[b].apply(this,c)}};
nBirdEvents.prototype.once=function(a,b){this.on(a,function d(){this.off(a,d);b.apply(this,arguments)})};var NBirdDB=function(a){this.opts=a;this.event=lcx_events;this.auth=this.db="";this._isFirstConn=!0;this._uid=localStorage.getItem("nbird-uid")||"";this._refSess=this._refUser=this._sess=this._user="";this._listen={chats:{},users:{}};this._archives={};this.$_user={};this.$_users={};this.$_onlineOps={};this.$_msgs={};this.$_chats={};this.$_chatReqs={};this.$_members={}};
...
NBirdDB.prototype.pushMsg=function(a,b,c,d,e){var f={},k=this.db.ref("messages").push().key,h=this.$_user,l="frontend"===this.opts.platform?h.nickname:h.name;f["chats/"+a+"/lastMsg"]=b;f["messages/"+a+"/"+k]={chatid:a,date:firebase.database.ServerValue.TIMESTAMP,msg:b,name:l||"",photoURL:h.photoURL||"",uid:this._uid,platform:this.opts.platform};f["users/"+this._uid+"/lastSeen"]=firebase.database.ServerValue.TIMESTAMP;f=this.getJoinChatUpdates(a,f);if(d)for(var g in d)f[g]=d[g];this.db.ref().update(f).then(c)["catch"](e)};
...
var nightBird=function(a,b){this.opts=a;this.str=b;this.event=lcx_events;this._i=this.opts._iframe;this._d=this._i.contentWindow.document;this._w=this._i.contentWindow.window;this._widget=this._i.parentNode;this._wstate=!0;this._wtitle=document.title;this._wtimeout=!1;this._mode="loading";this._pstate=!1;this._popup="";this._chatid=sessionStorage.getItem("lcx-chatid")||"";this._chat=null;this._lastchatid="";this._chats={};this._unreads={};this._lastBreak=this._lastPlatform=this._lastuid="";this._dbInit=
!1;this._initMsg="";this._cnvList={};this._user=this._uname=this._uid="";this.$_msgs={};this.$_members={};this.$_profile={};this.$_onlineOps=this.$_operators=null;this.$_chats={};this.opts.autoinit&&this.init()};
nightBird.prototype.init=function(){var a=this;this.$btn=this._d.getElementById("lcx-starter");this.$menu=this._d.getElementById("lcx-menu");this.$ntf=this._d.getElementById("lcx-ntfs");this.$popup=this._d.getElementById("lcx-popup");this.$pbody=this._d.getElementById("lcx-popup-body");this.$pchead=this._d.getElementById("lcx-pcontent-header");this.$pcbody=this._d.getElementById("lcx-pcontent-body");this.$pcfoot=this._d.getElementById("lcx-pcontent-footer");firebase.initializeApp({apiKey:this.opts.db.apiKey,
authDomain:this.opts.db.authDomain,databaseURL:this.opts.db.databaseURL});this.db=firebase.database();this.auth=firebase.auth();this.db.ref(".info/connected").on("value",function(b){!0===b.val()?(a._isFirstConn=!1,a._onConnect()):a._onDisconnect("networkError")});this.auth.onAuthStateChanged(function(b){a._onAuthState(b)});this.__msgWrap=this._d.getElementById("__lcx-msg--wrapper").innerHTML;this.actions();this.actions(document);this._uiEvents()};
nightBird.prototype._uiEvents=function(){var a=this;this._pstate&&setTimeout(function(){a.open(a._popup)},300);this.$btn.addEventListener("click",function(b){b.preventDefault();a._pstate?a.close():a.open()});this.$menu.addEventListener("click",function(b){b.preventDefault();a.open("cnv")});this.$popup.addEventListener("mouseenter",function(){a.readChat()});var b=function(){450>=(window.innerWidth||document.documentElement.clientWidth||document.body.clientWidth)?(a._widget.classList.add("lcx-mobileView"),
a._d.body.classList.add("lcx-mobileView")):(a._widget.classList.remove("lcx-mobileView"),a._d.body.classList.remove("lcx-mobileView"))};b();window.addEventListener("resize",b,!0)};
nightBird.prototype.actions=function(a){var b=this;a=a?a:this._d;var c=a.getElementsByClassName("lcx-action");if(c){a=function(a){a.preventDefault();a=this.getAttribute("data-action");switch(a){case "openPopup":(a=this.getAttribute("data-value"))||!b._pstate?b.open(a):b.close();break;case "closePopup":b.close();break;case "newChat":a=this.getAttribute("data-value");b.resetChat();b.open("online");b.delAttr("offline");a=a?[a]:null;b.createTmpChat(a);break;case "endChat":b.updateChat({status:"close"});
break;case "online":case "away":b.mode(a)}};c=$jscomp.makeIterator(c);for(var d=c.next();!d.done;d=c.next())d.value.addEventListener("click",a)}};
nightBird.prototype.open=function(a,b){b||this._popup&&a||(a=localStorage.getItem("lcx-popup")||this.opts.initPopup);this.opts.allowedPopups.includes(a)||(a=this.opts.initPopup);this._d.body.classList.add("lcx--open");this._widget.classList.add("lcx--open");this.$btn.classList.add("lcx--active");this.$popup.classList.add("lcx--active");this._pstate=!0;this.goPage(a);this.delAppMsgs();this._onOpenPopup()};
nightBird.prototype.close=function(){this._d.body.classList.remove("lcx--open");this._widget.classList.remove("lcx--open");this.$btn.classList.remove("lcx--active");this.$popup.classList.remove("lcx--active");this._pstate=!1;this._onClosePopup()};nightBird.prototype.resetUser=function(){var a=this.db.ref("users/"+this._uid);a.off();a.child("/lastSeen").onDisconnect().cancel();this._user=this._uname=this._uid="";this.$_profile={};window.localStorage.removeItem("lcx-refreshToken")};
nightBird.prototype.startSess=function(){var a=this.db.ref("users/"+this._uid+"/sessions/"+this.opts.platform);a.set({started:firebase.database.ServerValue.TIMESTAMP});a.onDisconnect().remove()};
nightBird.prototype.startChat=function(a,b){var c=this,d=this.db.ref("chats").push(),e=d.key,f=firebase.database.ServerValue.TIMESTAMP,k=this._uid,h={name:this._uname,subject:a,lastMsg:a,date:f,visitorid:k,status:"init",type:"support"};this.db.ref("caseNo").transaction(function(a){return(a||100222E3)+1}).then(function(a){h.caseNo=a.snapshot.val();return d.set(h)}).then(function(){return c.db.ref("members/"+e+"/"+k).set({chatid:e})}).then(function(){return c.db.ref("users/"+k+"/chatsAsVisitor/"+e).set(!0)}).then(function(){return c.db.ref("messages/"+
e).push({chatid:e,date:f,msg:a,name:c._uname,platform:"frontend",photoURL:c._user.photoURL,uid:c._uid,type:b})}).then(function(){c.openChat(e);c._onNewChat(e)})["catch"](function(a){c.createNtf(a.message,"error");console.error(a)})};nightBird.prototype.openChat=function(a){a in this.$_chats&&(this._lastchatid=this._chatid=a,sessionStorage.setItem("lcx-chatid",a),this._chat=this.$_chats[a],this.attr("chat-id",a),this.attr("chat-status",this._chat.status),this._lastchatid!==a&&this._onOpenChat(a,this._chat))};
...
nightBird.prototype.createTmpChat=function(a){this.resetChat();if(a){var b=Date.now();a=$jscomp.makeIterator(a);for(var c=a.next();!c.done;c=a.next())c=c.value,this.createMsg("basic","_initMsg-"+this.rand(),{date:b,unread:!0,msg:c,tmpMsg:!0,isYou:!0,sound:"first-msg"})}this.goPage("online")};nightBird.prototype.mode=function(a){this._mode=a;this.attr("mode",a);this.showOps();this.refreshAwayUI();this.event.emit("mode",a)};
...
nightBird.prototype.createMsg=function(a,b,c){a=void 0===a?"basic":a;c=void 0===c?{}:c;if(this.$msgs){var d=new Date,e=Date.now(),f=(c.date?new Date(c.date):d).toDateString(),k=f===d.toDateString();d=new Date(d.setDate(d.getDate()-1));d=f===d.toDateString();var h=c.date||e;c.uid=c.uid||this._uid||null;c.platform=c.platform||this.opts.platform;c.fullDate=this.time(h,k?"H:i":this.opts.dateFormat+" H:i");h=c.isYou||this._uid===c.uid&&c.platform===this.opts.platform;var l=this._lastBreak&&this._lastBreak!==
f,g=c.uid===this._lastuid&&c.platform===this._lastPlatform,p=["lcx-msg-item"],m=this._d.getElementById("__lcx-msg--"+a);if(m){c.msg&&(c.msg=this.sanitize(c.msg));var n="lcx-msg-"+b;this.delObj(this.$popup.querySelector("."+n));b=document.createElement("div");b.id=n;b.className="lcx-msg lcx-msg--"+a+" "+n;b.innerHTML=this.replace(m.innerHTML,c,!0);if(m=this.$msgs?this.$msgs.lastElementChild:null)if(n=m.querySelector(".lcx-msg-meta"))n.innerText="";!g||l?(g=document.createElement("div"),g.innerHTML=
this.__msgWrap,c.unread&&p.push("lcx--new"),h&&p.push("lcx--you"),g.className=p.join(" "),g.querySelector(".lcx-msg-container").appendChild(b),g.querySelector(".lcx-msg-avatar img").src=c.avatar||this.opts.companyLogo||this.opts.anonymousImage,c.meta&&(g.querySelector(".lcx-msg-meta").innerHTML=c.meta),l&&(h="",l=document.createElement("div"),e=Math.abs(c.date/1E3)||e,k?h=this.str.date_today:d&&(h=this.str.date_yesterday),l.className="lcx-breakpoint",l.innerHTML='<span datetime="'+e+'">'+h+"</span>",
h||this.timeago(l.querySelector("span")),this.$msgs.appendChild(l)),this.$msgs.appendChild(g)):(c.unread&&b.classList.add("lcx--new"),h&&b.classList.add("lcx--you"),m&&m.querySelector(".lcx-msg-container").appendChild(b),c.meta&&(m.querySelector(".lcx-msg-meta").innerHTML=c.meta));c.tmpMsg?this._initMsg=b.id:(this._lastuid=c.uid,this._lastPlatform=c.platform);this.scrollDown(this.$pbody);this._lastBreak=f;c.sound&&this.play(c.sound,this.opts._pluginurl);this._onCreateMsg(a,c.id,c)}}};
...
nightBird.prototype.createNtf=function(a,b,c,d){b=void 0===b?"error":b;var e="lcx-ntf-"+this.rand(),f=document.createElement("div");f.id=e;f.className="lcx-ntf lcx-ntf--"+b;f.innerHTML='<span class="lcx-ntf-content">'+a+"</span>";c&&(this.hideNtf(c),f.classList.add("lcx-ntf-group-"+c));d&&setTimeout(this.delObj.bind(this,e),3E3);this.$ntf.appendChild(f)};
nightBird.prototype.hideNtf=function(a){if(a=this._d.getElementsByClassName("lcx-ntf-group-"+a)){a=$jscomp.makeIterator(a);for(var b=a.next();!b.done;b=a.next())this.delObj(b.value)}};
nightBird.prototype.listenReply=function(a,b){var c=this;a&&(a.addEventListener("keydown",function(a){this.disabled?a.preventDefault():a&&13===a.keyCode&&!a.shiftKey&&(0!==this.innerText.length&&(c.pushMsg(this.innerHTML),this.innerText=""),a.preventDefault())}),a.addEventListener("paste",function(a){a.preventDefault();a=a.clipboardData.getData("text/plain");c._d.execCommand("insertHTML",!1,a)}),b&&a.focus())};
...
this.$_operators&&(d=this.$_operators[this._chat.opid]);f=this._chat.opid in this.$_onlineOps?"online":"away";var k=d.photoURL||this.opts.companyLogo;this.attr("op-status",f);this.$popup.querySelector(".lcx-current-op-name").innerHTML=d.name;this.$popup.querySelector(".lcx-current-op-pic").innerHTML='<img src="'+k+'" alt="" />';this.$popup.querySelector(".lcx-current-op-desc").innerHTML=this.str["ops_status_"+f]}else if("online"===this._mode&&this.$_onlineOps)for(k in this.$_onlineOps)f(k);else if(this.$_operators){var h=
0;for(k in this.$_operators)if(f(k),h++,3===h)break}else b.classList.add("__lcx-hide")}};
...
nightBird.prototype.createCnv=function(a,b){var c=this;if(!(a in this._cnvList)){var d={};b.opid&&(d=this.$_operators[b.opid]);var e=document.createElement("a"),f=this._d.getElementById("__lcx-cnv--item"),k=d.photoURL||this.opts.companyLogo;b.author=d.name||this.opts.companyName;b.date=Math.abs(b.date/1E3);k&&(b.avatar='<img src="'+k+'" alt="" />');e.id="lcx-cnv-item-"+a;e.innerHTML=this.replace(f.innerHTML,b,!0);e.className="lcx-cnv lcx-row";e.setAttribute("data-chatid",a);e.addEventListener("click",
function(a){a.preventDefault();a=this.getAttribute("data-chatid");c.resetChat();c.openChat(a);c.goPage("online")});this._cnvList[a]=e}};nightBird.prototype.updateChat=function(a,b){this._chatid?this.db.ref("chats/"+this._chatid).update(a).then(b):b&&b(!1)};nightBird.prototype.readChat=function(a){this.updateChat({lastRead:firebase.database.ServerValue.TIMESTAMP},a);document.title=this._wtitle;window.clearInterval(this._wtimeout);this._chatid in this._unreads&&delete this._unreads[this._chatid];this.updateCount()};
...
nightBird.prototype._onOnlineOpsUpdate=function(a){var b=a.exists()?"online":"away";this.$_onlineOps=a.exists()?a.val():{};this.mode(b)};
nightBird.prototype._onConnect=function(){var a=this;this.hideNtf("conn");this.attr("connected",!0);this._dbInit?this.createNtf(this.str.ntf_connected,"success","conn",!0):(this.db.ref("operators").orderByChild("lastOnline").on("value",function(b){a.$_operators=b.exists()?b.val():null}),this.db.ref("onlineOps").on("value",this._onOnlineOpsUpdate.bind(this)),this._dbInit=!0,this.event.emit("connect"))};
...
nightBird.prototype._onProfileUpdate=function(a){if(a.exists()){var b=a.val();this.$_profile=b;if(b.chatsAsVisitor)for(var c in b.chatsAsVisitor)this._onNewChat(c);c={currentPageUrl:this._w.location.href};if(!b.nickname)for(var d in this.opts.user._nickname)c[d]=this.opts.user._nickname[d];this.opts.user._custom&&(c.custom=this.opts.user._custom);this.db.ref("users/"+a.key).update(c);this.event.emit("profile",this.$_profile)}};
nightBird.prototype._onAuthState=function(a){if(a){this._uid=a.uid;this._uname=a.displayName;this._user=a;var b=firebase.database.ServerValue.TIMESTAMP,c=this.db.ref("users/"+a.uid);c.child("lastSeen").onDisconnect().set(b);window.localStorage.setItem("lcx-refreshToken",a.refreshToken);c.on("value",this._onProfileUpdate.bind(this));this.startSess();this.event.emit("signin",a)}else this.resetUser(),this.event.emit("signout",a)};
...
nightBird.prototype._onNewMsg=function(a,b){var c=this,d=a.val(),e=a.key;if(d.chatid in this.$_chats){var f=this.$_chats[d.chatid].lastRead||null;d.__unread=f&&f<d.date&&(d.platform!==this.opts.platform||d.uid!==this._uid)}this._initMsg&&(this.updateMsgMeta(this._initMsg,this.str.date_seconds+"."),this._initMsg="");this.$_msgs[d.chatid][e]=d;f=d.uid===this._uid?"msg-alt":"msg";if(d.__unread){this.inAppMsg(d.msg,d.name,d.chatid);this.play("msg");var k=this.str.ntf_newMsg_wtitle.replace("%s",d.name);
this._wtimeout=window.setInterval(function(){document.title=document.title===k?c._wtitle:k},700);this._unreads[d.chatid]=!0}this.updateCount();this._chatid===d.chatid&&this.createMsg(d.type,e,{date:d.date,unread:d.__unread||!1,msg:d.msg,uid:d.uid,platform:d.platform,sound:f});this.freezeReply(!1);this.event.emit("newMsg",e,d,b)};nightBird.prototype._onUpdateMsg=function(a,b){var c=a.val(),d=a.key;this.$_msgs[c.chatid][d]=c;this.event.emit("updateMsg",d,c,b)};
