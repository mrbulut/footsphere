...
class LiveChatX_App extends LiveChatX_Abstract {
    ...
    public function register_post_types() {
       ...
       /* // Chat post-type
        $labels = array(
            'name'                => _x( 'Chat logs', 'Post Type General Name', 'lcx' ),
            'singular_name'       => _x( 'Chat log', 'Post Type Singular Name', 'lcx' ),
            'menu_name'           => __( 'Chat logs', 'lcx' ),
        ...
        register_post_type( 'lcx_chat', $args );

        // Offline messages post-type
        $labels = array(
            'name'                => _x( 'Offline messages', 'Post Type General Name', 'lcx' ),
            'singular_name'       => _x( 'Offline message', 'Post Type Singular Name', 'lcx' ),
            'menu_name'           => __( 'Offline messages', 'lcx' ),
            'parent_item_colon'   => __( 'Parent item:', 'lcx' ),
            'all_items'           => __( 'All', 'lcx' ),
            'view_item'           => __( 'View', 'lcx' ),
            'add_new_item'        => __( 'Add new', 'lcx' ),
        ...
        register_post_type( 'lcx_offline_msg', $args );

        // Custom form post-type
        $labels = array(
            'name'                => _x( 'Custom forms', 'Post Type General Name', 'lcx' ),
            'singular_name'       => _x( 'Custom form', 'Post Type Singular Name', 'lcx' ),
            'menu_name'           => __( 'Custom forms', 'lcx' ),
            'parent_item_colon'   => __( 'Parent item:', 'lcx' ),
            'all_items'           => __( 'All', 'lcx' ),
            'view_item'           => __( 'View', 'lcx' ),
            'add_new_item'        => __( 'Add new', 'lcx' ),
        ...
        register_post_type( 'lcx_custom_form', $args );*/
