...
class LCX_Options extends LiveChatX_Abstract  {
    ...
    function validate( $input ) {
        ...
        $compile_var = array(
            ...
            'starterSize' => $input['design_ui_starter_size'] . 'px',
            'offsetX' => $input['design_ui_offset_x'] . 'px',
            'offsetY' => $input['design_ui_offset_y'] . 'px',
            'starterIconW' => $input['design_ui_starter_icon_size'] . 'px',
