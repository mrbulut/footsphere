...
<div id="__lcx-popup-footer-online" class="__lcx-tpl">
        ...
        <div class="lcx-row">
            <div class="lcx-col">
                ...
                <div class="lcx-rating">
                    <a href="#" class="lcx-btn lcx-btn--sm lcx-btn--lined lcx-btn--success lcx-btn-chat-solved lcx-btn-vote" data-vote="yes"><?php echo file_get_contents( LCX_PATH . '/assets/icons/chatbox/like.svg' ); ?> <?php echo $msg['popup_solved']; ?></a>
    ...
    <div class="lcx-send lcx-send--offline __lcx-center lcx-showOnOffline __lcx-hide">
