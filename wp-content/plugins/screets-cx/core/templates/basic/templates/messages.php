...
<div id="__lcx-msg--collector" class="__lcx-tpl">
	<div class="__lcx-msg">
		...
		<div class="lcx-form lcx-form--collector">
			...
			<form class="lcx-form-field lcx-field-<?php echo $name; ?> lcx-step-<?php echo $i+1; ?> lcx-form-field--suffix">
				...
				<div class="lcx-row">
					...
					<div class="lcx-col lcx-col--auto">
						<a href="" class="lcx-btn lcx-btn lcx-btn--narrow"><?php echo file_get_contents( LCX_PATH . '/assets/icons/chatbox/ok.svg' ); ?></a>
					</div>
				</div>
