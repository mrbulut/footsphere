...
final class LiveChatX 
{
	...
	private function define_constants() {
		...
		define( 'LCX_CHANGELOG_URL', 'https://screets.com/chat' );
		define( 'LCX_URL', plugins_url( basename( plugin_dir_path( __FILE__ ) ), basename( __FILE__ ) ) );
		define( 'LCX_SLUG', 'lcx' );
	...
	function load_plugin_textdomain() {
		...
		if( has_action( 'wpml_register_single_string' ) ) {
			foreach( $this->__opts as $id => $opt ) {
				$string = $this->opts->getOption( $id );
				do_action( 'wpml_register_single_string', LCX_NAME, $id, $string );
			}
		}*/
