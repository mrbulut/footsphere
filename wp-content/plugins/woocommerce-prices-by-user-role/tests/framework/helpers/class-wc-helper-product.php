...
class WC_Helper_Product {
    ...
    public static function create_simple_product() {
        ...
        update_post_meta( $product, $priceKey, '10' );
        update_post_meta( $product, $regularPriceKey, '10' );
        update_post_meta( $product, $salePriceKey, '' );
    ...
    public static function create_variation_product() {
        ...
        // Price related meta
        update_post_meta( $product_id, $priceKey, '10' );
        ...
        // Price related meta
        update_post_meta( $variation_id, $priceKey, '10' );
        update_post_meta( $variation_id, $regularPriceKey, '10' );
        ...
        // Price related meta
        update_post_meta( $variation_id, $priceKey, '15' );
        update_post_meta( $variation_id, $regularPriceKey, '15' );
