			...
			foreach ( $theme_menu_locations as $key => $value ){
				...
				$locations_options = array_merge( 
					$locations_options, array(
						...
						array(
							'name' => __( 'Height of the first level items', $constants[ 'MM_TEXTDOMAIN_ADMIN' ] ),
							'descr' => __( 'Set the height for the initial menu container and items of the first level.', $constants[ 'MM_TEXTDOMAIN_ADMIN' ] ),
						...
						array(
							...
							'values' => array(
								...
								__( 'Buttons <small>(+1 option)</small>', $constants[ 'MM_TEXTDOMAIN_ADMIN' ] ) => 'buttons',
							),
							'default' => array( 'flat', ),
						),
						array(
						...
						array(
							...
							'values' => array(
								...
								__( 'Justify (No Logo!)', $constants[ 'MM_TEXTDOMAIN_ADMIN' ] ) => 'justify',
							),
							'default' => array( 'left', ),
						),
						array(
						...
						array(
							'name' => __( 'Trigger', $constants[ 'MM_TEXTDOMAIN_ADMIN' ] ),
							'descr' => __( 'Show dropdowns by "hover" or "click"?', $constants[ 'MM_TEXTDOMAIN_ADMIN' ] ),
							'key' => $key . '_dropdowns_trigger',
							'type' => 'radio',
							'col_width' => 4,
							'values' => array(
								__( 'Hover', $constants[ 'MM_TEXTDOMAIN_ADMIN' ] ) => 'hover',
								__( 'Click', $constants[ 'MM_TEXTDOMAIN_ADMIN' ] ) => 'click',
							),
							'default' => array( 'hover', ),
						),
						array(
						...
						array(
							...
							'col_width' => 4,
							'values' => array(
								__( 'Horizontal <small>(+5 option)</small>', $constants[ 'MM_TEXTDOMAIN_ADMIN' ] ) => 'horizontal',
						...
						array(
							...
							'descr' => __( 'Check this option to make the menu sticky. Incompatible with the "Vertical" menu. Sticky do not working on mobile devices. If the menu will be is sticky on mobile devices when you open it - you can not click on the last item, because it will always be outside the screen.', $constants[ 'MM_TEXTDOMAIN_ADMIN' ] ),
						...
						array(
							'name' => __( 'Push Content Down', $constants[ 'MM_TEXTDOMAIN_ADMIN' ] ),
							'descr' => __( 'Dropdown areas pushes the main website content down instead to dropping down over content. This option will be useful only for "Multi column" and "Full width" dropdowns.', $constants[ 'MM_TEXTDOMAIN_ADMIN' ] ),
						...
						array(
							'name' => __( 'Shortcode', $constants[ 'MM_TEXTDOMAIN_ADMIN' ] ),
							'descr' => __( 'You can copy this code and use in the content of the page in order to display this menu. Do not forget to activate mega menu for this location, using option at the beginning of this page.', $constants[ 'MM_TEXTDOMAIN_ADMIN' ] ),
			...
			$locations_options = array_merge( 
				$locations_options, array(
					...
					array(
						...
						'key' => 'backup',
						'type' => 'just_html',
						'default' => '<a href="' . get_admin_url() . '?' . $constants[ 'MM_WARE_PREFIX' ] . '_page=backup_file">' . __( 'Download backup file with current settings') . '</a><br /><br />' . __( 'Upload backup file and restore settings. Chose file and click "Save All Settings".') . '<br /><input class="col-xs-12 form-control input-sm" type="file" name="' . $constants[ 'MM_OPTIONS_NAME' ] . '_backup" />',
					),
				) // 'options' => array
			);
...
*/
						...
						array(
							'name' => __( 'Background Gradient (Color) of the Dropdown Area', $constants[ 'MM_TEXTDOMAIN_ADMIN' ] ),
...
*/
				...
				$skins_options, array(
					...
					array(
						...
						'values' => array(
							...
							array(
								'name' => __( 'Icon File on Hover', $constants[ 'MM_TEXTDOMAIN_ADMIN' ] ),
								'descr' => __( 'Keep empty to use regular for both', $constants[ 'MM_TEXTDOMAIN_ADMIN' ] ),
			...
			return array(
				...
				array(
					...
					'options' => array(
						...
						array(
							'name' => __( 'Use sets of icons', $constants[ 'MM_TEXTDOMAIN_ADMIN' ] ),
							'descr' => __( 'Here you can activate different sets of icons. Remember that the larger the list of icons - require more of time to loading page.', $constants[ 'MM_TEXTDOMAIN_ADMIN' ] ),
							'key' => 'icon_sets',
							'type' => 'checkbox',
							'values' => array(
								__( 'IcoMoon (1200)', $constants[ 'MM_TEXTDOMAIN_ADMIN' ] ) => 'icomoon',
								__( 'FontAwesome (400)', $constants[ 'MM_TEXTDOMAIN_ADMIN' ] ) => 'fontawesome',
								__( 'Glyphicons (200)', $constants[ 'MM_TEXTDOMAIN_ADMIN' ] ) => 'glyphicons',
							),
							'default' =>  array(
								'icomoon',
							),
						...
						array(
							'name' => __( 'max_input_vars', $constants[ 'MM_TEXTDOMAIN_ADMIN' ] ),
							'descr' => __( 'This is real value of "max_input_vars" option in the configuration of your server. You can try to increase it in one of ways that are described in <a href="http://manual.menu.megamain.com/#max_input_vars" target="_blank">Documentation</a>.', $constants[ 'MM_TEXTDOMAIN_ADMIN' ] ),
	...
	*/
						...
						array(
							'name' => __( 'Pull to the Other Side', $constants[ 'MM_TEXTDOMAIN_ADMIN' ] ),
				...
				array(
					...
					'options' => array(
						array(
							...
							'key' => 'support',
							'type' => 'just_html',
							'default' => '<br /><br /> <a href="http://manual.menu.megamain.com/" target="_blank">Online documentation</a>. <br /><br /> If you need support, <br /> If you have a question or suggestion - <br /> Leave a message on our support page <br /> <a href="http://support.megamain.com/?ref=' . $_SERVER["HTTP_HOST"] . $_SERVER["REQUEST_URI"] . '" target="_blank">Support.MegaMain.com</a> (in new window).<br /> <br />',
						),
						array(
							'name' => __( 'Purchase Code', $constants[ 'MM_TEXTDOMAIN_ADMIN' ] ),
							'descr' => __( 'Enter here the purchase code of this product. This action unlocks the automatic updates for you. "Where you can find your <a href="http://support.megamain.com/src/img/megamain-find-item-purchase-code.png" target="_blank">Purchase Code</a>".', $constants[ 'MM_TEXTDOMAIN_ADMIN' ] ),
							'key' => 'purchase_code',
							'type' => 'textfield',
							'col_width' => 6,
							'default' => '',
