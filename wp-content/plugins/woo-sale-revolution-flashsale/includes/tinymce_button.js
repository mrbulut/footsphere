	...
	tinymce.PluginManager.add('flash_sale_shortcodes_button', function( editor, url ) {
        editor.addButton( 'flash_sale_shortcodes_button', {
            ...
            onclick: function() {
				...
				W = W - 80;
				H = H - 84;
				tb_show( 'Flash Sale Shortcode', '#TB_inline?width=' + W + '&height=' + H + '&inlineId=flash_sale_adv-shortcodes-form' );
            }
        });
    });
...
.flash_sale_adv-shortcodes-form { display: block; overflow: hidden; height: 100%; position: relative; font-family: Helvetica, Arial; color: #333; font-size: 12px; text-align: left; background: #FFF; }\
.flash_sale_adv-shortcodes-form a { text-decoration: none; }\
.flash_sale_adv-shortcodes-form .flash_sale_adv-shortcodes-form-top { overflow: auto; height: 100%; position: relative; padding: 0 0 0 120px; margin: 0 0 0 0; }\
.flash_sale_adv-shortcodes-form .flash_sale_adv-shortcodes-form-types { position: absolute; top: 0px; left: 0px; width: 120px; height: 100%; min-height: 100%; background: #f9f9f9; border-right: 1px solid #EEE; }\
.flash_sale_adv-shortcodes-form .flash_sale_adv-shortcodes-form-types .flash_sale_adv-shortcodes-form-title { display: block; padding: 14px 20px 14px 40px; position: relative; font-size: 12px; line-height: 14px; color: #333; border-bottom: 1px solid #EEE; }\
.flash_sale_adv-shortcodes-form .flash_sale_adv-shortcodes-form-types .flash_sale_adv-shortcodes-form-title img { position: absolute; top: 13px; left: 12px; } \
.flash_sale_adv-shortcodes-form .flash_sale_adv-shortcodes-form-types ul { list-style: none; margin: 0px; padding: 0px; }\
.flash_sale_adv-shortcodes-form .flash_sale_adv-shortcodes-form-types ul li { display: block; border-bottom: 1px solid #EEE; margin: 0px; }\
.flash_sale_adv-shortcodes-form .flash_sale_adv-shortcodes-form-types ul li.active { width: 121px; font-weight: bold; }\
.flash_sale_adv-shortcodes-form .flash_sale_adv-shortcodes-form-types ul li a { display: block; padding: 14px 20px; font-size: 12px; color: #333; }\
.flash_sale_adv-shortcodes-form .flash_sale_adv-shortcodes-form-types ul li.active a,  .flash_sale_adv-shortcodes-form .flash_sale_adv-shortcodes-form-types ul li a:hover { background: #FFF; }\
.flash_sale_adv-shortcodes-form .flash_sale_adv-shortcodes-form-tabs { background: #FFF; padding: 20px 20px 70px 20px; overflow: hidden; }\
.flash_sale_adv-shortcodes-form .flash_sale_adv-shortcodes-form-tab { display: none; }\
.flash_sale_adv-shortcodes-form .flash_sale_adv-shortcodes-form-tabs h2 { display: block; padding: 0 10px 10px 10px; line-height: normal; font-size: 18px; margin: 0 0 10px 0; border-bottom: 1px solid #EEE; }\
.flash_sale_adv-shortcodes-form .flash_sale_adv-shortcodes-form-fields { overflow: auto; }\
.flash_sale_adv-shortcodes-form .flash_sale_adv-shortcodes-form-tabs table { width: 100%; border: none; font-size: 12px; text-align: left; }\
.flash_sale_adv-shortcodes-form .flash_sale_adv-shortcodes-form-tabs table th,  .flash_sale_adv-shortcodes-form .flash_sale_adv-shortcodes-form-tabs table td { padding: 14px 10px 14px 0; border-bottom: 1px solid #EEE; vertical-align: top; }\
.flash_sale_adv-shortcodes-form .flash_sale_adv-shortcodes-form-tabs table th { font-weight: normal; text-align: left; width: 120px; }\
.flash_sale_adv-shortcodes-form .flash_sale_adv-shortcodes-form-tabs table th label { padding: 5px 0 0 10px; display: block; }\
.flash_sale_adv-shortcodes-form .flash_sale_adv-shortcodes-form-tabs table td input, .flash_sale_adv-shortcodes-form .flash_sale_adv-shortcodes-form-tabs table td textarea { border: 1px solid #DDD; box-shadow: inset 1px 1px 4px #f9f9f9; padding: 6px 8px; font-family: Helvetica; font-size: 12px; color: #888; width: 80%; }\
.flash_sale_adv-shortcodes-form .flash_sale_adv-shortcodes-form-tabs table td .wp-picker-container input[type="text"] { width: 80px!important; margin: 0 5px 0 0; }\
.flash_sale_adv-shortcodes-form .flash_sale_adv-shortcodes-form-tabs table td .wp-picker-container input.button { width: auto!important; }\
.flash_sale_adv-shortcodes-form .flash_sale_adv-shortcodes-form-tabs table td textarea { height: 100px; }\
.flash_sale_adv-shortcodes-form .flash_sale_adv-shortcodes-form-tabs table td textarea:disabled { background: #EEE; }\
.flash_sale_adv-shortcodes-form .flash_sale_adv-shortcodes-form-tabs table td input:focus, .flash_sale_adv-shortcodes-form .flash_sale_adv-shortcodes-form-tabs table td textarea:focus { color: #333; border-color: #BBB; background: #FFF; outline: none; }\
.flash_sale_adv-shortcodes-form .flash_sale_adv-shortcodes-form-tabs table td span.tip { display: block; padding: 5px 0; color: #999; }\
.flash_sale_adv-shortcodes-form .flash_sale-shortcodes-submit { clear: both; height: 70px; position: absolute; bottom: 0px; left: 0px; width: 100%; background: #EEE; border-top: 1px solid #DDD; }\
.flash_sale_adv-shortcodes-form .flash_sale-shortcodes-submit .button-primary { position: absolute; right: 20px; top: 20px; }\
.flash_sale_adv-shortcodes-form .current-icon, .flash_sale_adv-shortcodes-form .current-social-icon { margin: 0 0 0 10px; font-size: 14px; width: 24px; text-align:center; height: 24px; line-height: 24px; }\
.flash_sale-shortcodes-toggle-social-list { margin: 0 0 20px 0; }\
.flash_sale_adv-shortcodes-form .social-icon, .flash_sale_adv-shortcodes-form .current-social-icon { margin: 0 0 0 10px; display: block; float: left; }\
.flash_sale_adv-shortcodes-form .current-social-icon { display: none; }\
.flash_sale_adv-shortcodes-form .social-icon img { width: 21px; height: 21px; margin: 1px 0 0 0; }\
.flash_sale_adv-shortcodes-form .flash_sale-shortcodes-social-link-field { float: left; width: 220px!important; margin: 0 0 0 10px; }\
.flash_sale_adv-shortcodes-form .flash_sale-shortcodes-icon-list-holder { clear: both; overflow: hidden; }\
.flash_sale_adv-shortcodes-form .flash_sale-shortcodes-icon-list { padding: 10px 0 0 0; display: block; list-style: none; margin: 0px; }\
.flash_sale_adv-shortcodes-form .flash_sale-shortcodes-icon-list li { display: block; float: left; width: 40px; height: 40px; margin: 0 10px 10px 0; }\
.flash_sale_adv-shortcodes-form .flash_sale-shortcodes-icon-list li a { display: block; float: left; width: 40px; height: 40px; text-align: center; line-height: 40px; background: #f9f9f9; border: 1px solid #EEE; }\
.flash_sale_adv-shortcodes-form .flash_sale-shortcodes-icon-list li a:hover { border: 1px solid #CCC; box-shadow: 1px 1px 2px #EEE; }\
.flash_sale_adv-shortcodes-form .flash_sale-shortcodes-icon-list li a i { font-size: 14px; }\
.flash_sale_adv-shortcodes-form .flash_sale-shortcodes-icon-list li a img { width: 20px; height: 20px; margin-top: 10px; }\
.flash_sale_adv-shortcodes-form .flash_sale-shortcodes-icon-list li a span { display: none; }\
.flash_sale_adv-shortcodes-form .column-structures { display: block; padding: 0 0 0 10px; }\
.flash_sale_adv-shortcodes-form .column-structures a { display: block; width: 100px; height: 40px; float: left; margin: 0 10px 20px 0; }\
.flash_sale_adv-shortcodes-form .column-structures a span { float:left; position: relative; display: block; height: 40px; overflow: hidden; }\
.flash_sale_adv-shortcodes-form .column-structures a i { background: #EEE; position: absolute; left: -2px; top: 0px; display: block; height: 40px; line-height: 40px; font-size: 14px; text-align: center; width: 100%; }\
.flash_sale_adv-shortcodes-form .column-structures a:hover i, .flash_sale_adv-shortcodes-form .column-structures a.active i { background: #999; color: #FFF; }\
.flash_sale_adv-shortcodes-form .column-structures label { margin: 0 0 14px 0; display: block; font-size: 14px; }\
\
.flash_sale_adv-shortcodes-form .column-structuress { display: block; padding: 0 0 0 10px; }\
.flash_sale_adv-shortcodes-form .column-structuress a { display: block; width: 100px; height: 40px; float: left; margin: 0 10px 20px 0; }\
.flash_sale_adv-shortcodes-form .column-structuress a span { float:left; position: relative; display: block; height: 40px; overflow: hidden; }\
.flash_sale_adv-shortcodes-form .column-structuress a i { background: #EEE; position: absolute; left: -2px; top: 0px; display: block; height: 40px; line-height: 40px; font-size: 14px; text-align: center; width: 100%; }\
.flash_sale_adv-shortcodes-form .column-structuress a:hover i, .flash_sale_adv-shortcodes-form .column-structuress a.active i { background: #999; color: #FFF; }\
.flash_sale_adv-shortcodes-form .column-structuress label { margin: 0 0 14px 0; display: block; font-size: 14px; }\
\
.flash_sale_adv-shortcodes-form .column-structuresss { display: block; padding: 0 0 0 10px; }\
.flash_sale_adv-shortcodes-form .column-structuresss a { display: block; width: 100px; height: 40px; float: left; margin: 0 10px 20px 0; }\
.flash_sale_adv-shortcodes-form .column-structuresss a span { float:left; position: relative; display: block; height: 40px; overflow: hidden; }\
.flash_sale_adv-shortcodes-form .column-structuresss a i { background: #EEE; position: absolute; left: -2px; top: 0px; display: block; height: 40px; line-height: 40px; font-size: 14px; text-align: center; width: 100%; }\
.flash_sale_adv-shortcodes-form .column-structuresss a:hover i, .flash_sale_adv-shortcodes-form .column-structuresss a.active i { background: #999; color: #FFF; }\
.flash_sale_adv-shortcodes-form .column-structuresss label { margin: 0 0 14px 0; display: block; font-size: 14px; }\
\
.flash_sale_adv-shortcodes-form .clearfix { clear: both; }\
#flash_sale_adv-shortcodes-form-tab_tabs td label,\
#flash_sale_adv-shortcodes-form-tab_accordion td label { display: block; padding: 5px 0 10px 0; color: #999; }\
#flash_sale_adv-shortcodes-form-tab_tabs input,\
#flash_sale_adv-shortcodes-form-tab_accordion input,\
#flash_sale_adv-shortcodes-form-tab_accordion .flash_sale-shortcodes-toggle-icon-list { margin: 0 0 10px 0; }\
</style>\
		<div id="flash_sale_adv-shortcodes-form"><div class="flash_sale_adv-shortcodes-form">\
		<div class="flash_sale_adv-shortcodes-form-top">\
		<div class="flash_sale_adv-shortcodes-form-types">\
			<ul>\
				<li class="flash_sale_adv-shortcodes-form-type-button active" type="product_rule"><a href="#">Products Carousel By Rule</a></li>\
				<li class="flash_sale_adv-shortcodes-form-type-columns" type="rule_list"><a href="#">Rules List</a></li>\
				<li class="flash_sale_adv-shortcodes-form-type-social" type="rule_slider"><a href="#">Rules Slider</a></li>\
				<li class="flash_sale_adv-shortcodes-form-type-social" type="top_products_carosel"><a href="#">Top Products Carousel</a></li>\
				<li class="flash_sale_adv-shortcodes-form-type-social" type="top_products_grid"><a href="#">Top Products Grid</a></li>\
			</ul>\
		</div><!-- end types -->\
		<div class="flash_sale_adv-shortcodes-form-tabs">\
<!-- product_rule -->\
			<div class="flash_sale_adv-shortcodes-form-tab" id="flash_sale_adv-shortcodes-form-tab_product_rule" style="display:block">\
				<h2>Add Rules List</h2>\
				<div class="flash_sale_adv-shortcodes-form-fields">\
				<table cellpadding="0" cellspacing="0">\
					<tr>\
						<th><label>Select Rule</label></th>\
						<td>\
					...
					<tr>\
						<th><label>Item Layout</label></th>\
						<td>\
							<select fieldname="item_layout">\
					...
					<tr>\
						<th><label>Item Image Effect</label></th>\
						<td>\
							<select fieldname="item_image_eff">\
								<option value="fl-none">None</option>\
								<option value="fl-zoomin">Zoom In</option>\
								<option value="fl-zoomin-long">Zoom In Long</option>\
								<option value="fl-zoomout">Zoom Out</option>\
								<option value="fl-grayscale">Grayscale</option>\
								<option value="fl-rotateright">Rotate Right</option>\
								<option value="fl-rotateleft">Rotate Left</option>\
								<option value="fl-blur">Blur</option>\
							</select>\
						</td>\
					</tr>\
					<tr>\
						<th><label>Thumbnail Size</label></th>\
						<td>\
							<select fieldname="product_thumb_size">\
								<option value="thumbnail">Thumbnail</option>\
								<option value="medium">Medium</option>\
								<option value="large">Large</option>\
								<option value="full">Full</option>\
								<option value="pw_hor_image">horizontal</option>\
								<option value="pw_ver_image">vertical</option>\
								<option value="pw_rec_image">square</option>\
							</select>\
						</td>\
					</tr>\
					<tr>\
					...
					<tr>\
						<th><label>Show Discount</label></th>\
						<td>\
							<select fieldname="show_discount">\
					...
					<tr>\
						<th><label>Countdown Style</label></th>\
						<td>\
					...
					<tr>\
						<th><label>Countdown Size</label></th>\
						<td>\
					...
					<tr>\
						<th><label>Description & Overlay Back Color</label></th>\
						<td>\
					...
					<tr>\
						...
						<td>\
							<input type="text" value="" fieldname="fl_custom_class" />\
						</td>\
					</tr>\
				</table>\
				</div>\
...
<!-- end tab -->\
			<!-- rule List -->\
			<div class="flash_sale_adv-shortcodes-form-tab" id="flash_sale_adv-shortcodes-form-tab_rule_list">\
				<h2>Add Rule List</h2>\
				<div class="flash_sale_adv-shortcodes-form-fields">\
				<table cellpadding="0" cellspacing="0">\
					<tr>\
						<th><label>Select Rule</label></th>\
						<td>\
							<select id="select_rules" fieldname="rule" class="chosen-select_rules" multiple="multiple" data-placeholder="Choose Rule" >\
					...
					<tr>\
						...
						<td>\
							<select fieldname="countdown_style">\
								...
								<option value="style2">Style 2</option>\
								<option value="style3">Style 3</option>\
								<option value="style3">Style 4</option>\
								<option value="style3">Style 5</option>\
								<option value="style3">Style 6</option>\
							</select>\
						</td>\
					</tr>\
					<tr>\
					...
					<tr>\
						<th><label>Countdown Position</label></th>\
						<td>\
							<select fieldname="countdown_position">\
					...
					<tr>\
						...
						<td>\
							<select fieldname="structure">\
									<option value="fl-col-md-12">One Column</option>\
									<option value="fl-col-md-6">Two Columns</option>\
									<option value="fl-col-md-4">Three Columns</option>\
									<option value="fl-col-md-3">Four Columns</option>\
								</select>\
						</td>\
					</tr>\
					<tr>\
						...
						<td>\
							<select fieldname="structure_tablet">\
								<option value="fl-col-sm-12">One Column</option>\
								<option value="fl-col-sm-6">Two Columns</option>\
								<option value="fl-col-sm-4">Three Columns</option>\
								<option value="fl-col-sm-3">Four Columns</option>\
							</select>\
						</td>\
					</tr>\
					<tr>\
						...
						<td>\
							<select fieldname="structure_mobile">\
								<option value="fl-col-xs-12">One Column</option>\
								<option value="fl-col-xs-6">Two Columns</option>\
								<option value="fl-col-xs-4">Three Columns</option>\
								<option value="fl-col-xs-3">Four Columns</option>\
							</select>\
						</td>\
					</tr>\
					<tr>\
...
<!-- rule_slider -->\
			<div class="flash_sale_adv-shortcodes-form-tab" id="flash_sale_adv-shortcodes-form-tab_rule_slider">\
				...
				<table cellpadding="0" cellspacing="0">\
					<tr>\
						...
						<td>\
							<select id="select_rules_slider" fieldname="rule" class="chosen-select_slider" multiple="multiple" data-placeholder="Choose Rules" >\
								<option value="">Select Rule</option>\
							</select>\
						</td>\
					</tr>\
					...
					<tr>\
						<th><label>Slider Direction</label></th>\
						<td>\
							<select fieldname="slider_direction">\
								<option value="vertical">Vertical</option>\
								<option value="Horizontal">Horizontal</option>\
							</select>\
						</td>\
					...
					<tr>\
						<th><label>Thumbnail Item Count</label></th>\
						<td>\
							<input type="text" value="" fieldname="slider_thumb_item_count" />\
						</td>\
					</tr>\
					<tr>\
						<th><label>Vertical Slider Height</label></th>\
						<td>\
							<input type="text" value="" fieldname="slider_ver_height" />\
						</td>\
					</tr>\
					<tr>\
						<th><label>Vertical Thumbnail Item Width</label></th>\
						<td>\
							<input type="text" value="" fieldname="slider_ver_thumb_width" />\
						</td>\
					</tr>\
					<tr>\
						<th><label>Slider Mode</label></th>\
						<td>\
...
<!-- top_products carosel-->\
			<div class="flash_sale_adv-shortcodes-form-tab" id="flash_sale_adv-shortcodes-form-tab_top_products_carosel">\
				<h2>Add products</h2>\
				<div class="flash_sale_adv-shortcodes-form-fields">\
				<table cellpadding="0" cellspacing="0">\
					<tr>\
					...
					<tr>\
						<th><label>Description Area Back Color</label></th>\
						<td>\
							<input type="text" class="flash_sale-shortcodes-button_colour_custom" fieldname="description_area_backcolour" value="" />\
						</td>\
					</tr>\
...
<!-- top_products Grid-->\
			<div class="flash_sale_adv-shortcodes-form-tab" id="flash_sale_adv-shortcodes-form-tab_top_products_grid">\
				<h2>Add products</h2>\
				<div class="flash_sale_adv-shortcodes-form-fields">\
				<table cellpadding="0" cellspacing="0">\
					<tr>\
					...
					<tr>\
						<th><label>Tablet Columns</label></th>\
						<td>\
							<select fieldname="column_tablet">\
								<option value="fl-col-sm-12">One Column</option>\
								<option value="fl-col-sm-6">Two Columns</option>\
								<option value="fl-col-sm-4">Three Columns</option>\
								<option value="fl-col-sm-3">Four Columns</option>\
					...
					<tr>\
						<th><label>Mobile Columns</label></th>\
						<td>\
							<select fieldname="column_mobile">\
								<option value="fl-col-xs-12">One Column</option>\
								<option value="fl-col-xs-6">Two Columns</option>\
								<option value="fl-col-xs-4">Three Columns</option>\
								<option value="fl-col-xs-3">Four Columns</option>\
...
<!-- top_products Grid-->\
			<div class="flash_sale_adv-shortcodes-form-tab" id="flash_sale_adv-shortcodes-form-tab_product_rule_auto">\
				<h2>Add products</h2>\
				<div class="flash_sale_adv-shortcodes-form-fields">\
				<table cellpadding="0" cellspacing="0">\
					<tr>\
						<th><label>Select Rules</label></th>\
						<td>\
							<select fieldname="rule" id="select_rule_grid">\
								<option value="">Select Rule</option>\
							</select>\
						</td>\
					</tr>\
		...
		<div class="flash_sale-shortcodes-submit">\
			<input style="display:none" id="flash_sale_adv-shortcodes-form-type" value="button" />\
			<textarea style="display:none" id="flash_sale_adv-shortcodes-form-code-to-add"></textarea>\
		...
		jQuery.ajax ({
			...
			data:   "action=pw_fetch_rule",
			success: function(data) {
				jQuery("#select_rule_grid").html(data);
				//confirm(data);
			}
		});
		jQuery.ajax ({
		...
		form.find('.flash_sale_adv-shortcodes-form-types ul li a').click(function(){
			flash_sale_shortcode_type = jQuery(this).parent('li').attr('type');
			jQuery('input#flash_sale_adv-shortcodes-form-type').val(flash_sale_shortcode_type);
			jQuery('.flash_sale_adv-shortcodes-form-tab').hide();
			jQuery('#flash_sale_adv-shortcodes-form-tab_'+flash_sale_shortcode_type).show();
			jQuery('.flash_sale_adv-shortcodes-form-types .active').removeClass('active');
			jQuery(this).parent('li').addClass('active');
			jQuery('.flash_sale_adv-shortcodes-form .flash_sale_adv-shortcodes-form-types').css({"height":jQuery('.flash_sale_adv-shortcodes-form-tabs').outerHeight()});
			return false;
		});
		...
		jQuery('.column-structures a').click(function() {
			...
			jQuery('#flash_sale_adv-shortcodes-form-tab_columns textarea').attr({'disabled':'disabled'});
			var i = -1;
			while(i < (num_of_columns - 1)) {
				i++;
				jQuery('#flash_sale_adv-shortcodes-form-tab_columns textarea').eq(i).removeAttr('disabled');
			}
		...
		form.find('#flash_sale_shortcodes-submit').click(function(){
			...
			if(flash_sale_shortcode_type == "product_rulea") {
				...
				flash_sale_shortcode_code = flash_sale_shortcode_code + '[flash_sale_' + flash_sale_shortcode_type + ']';
					...
					jQuery('#flash_sale_adv-shortcodes-form-tab_' + flash_sale_shortcode_type + ' td').each(function() {
			...
			//	flash_sale_shortcode_code = flash_sale_shortcode_code + '[/flash_sale_' + flash_sale_shortcode_type + ']';
				...
				jQuery('#flash_sale_adv-shortcodes-form-tab_' + flash_sale_shortcode_type + ' input, #flash_sale_adv-shortcodes-form-tab_' + flash_sale_shortcode_type + ' select, #flash_sale_adv-shortcodes-form-tab_' + flash_sale_shortcode_type + ' textarea').each(function() {
