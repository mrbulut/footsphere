...
class MysqliDb implements IDatabaseDao
{
    ...
    {
        $isSubQuery = false;
        $host = ConfigReader::Read("host","databaseConfig");
        $username = ConfigReader::Read("user","databaseConfig");
        $password = ConfigReader::Read("pass","databaseConfig");
        $db = ConfigReader::Read("db","databaseConfig");
    ...
    protected function _buildJoinOld()
    {
        ...
        foreach ($this->_join as $data) {
            ...
            $this->_query .= " " . $joinType . " JOIN " . $joinStr . (false !== stripos($joinCondition, 'using') ? " " : " on ")
                . $joinCondition;
        }
    }
    ...
    public function deleteUser($producerID)
    {
        require_once ABSPATH . "wp-admin/includes/user.php";
        require_once ABSPATH . "wp-includes/pluggable.php";
        require_once ABSPATH . "wp-admin/upgrade-functions.php";
        require_once ABSPATH . "wp-includes/registration.php";
        return wp_delete_user($producerID);
    
    }

   public function createProducer($user_name, $random_password, $user_email,$name)
    {
        require_once ABSPATH . "wp-includes/pluggable.php";
        require_once ABSPATH . "wp-admin/upgrade-functions.php";
        require_once ABSPATH . "wp-includes/registration.php";
    ...
    {
        wp_update_user(array('ID' => $userID, 'display_name' => $dispName));
        wp_update_user(array('ID' => $userID, 'user_email' => $email));
        if ($sifre != '') {
            wp_update_user(array('ID' => $userID, 'user_pass' => $sifre));
        }
    }
    ...
    public function setFirstName($value)
    {
        ...
        wp_update_user(array('ID' => self::getUserID(), 'first_name' => $value));
/*
    ...
    {
        wp_update_user(array('ID' => self::getUserID(), 'last_name' => $value));
